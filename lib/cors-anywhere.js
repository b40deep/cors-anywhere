...
function parseURL(req_url) {
  ...
  //                                              ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  //                                            2:host
  console.log(`_____________________parse_match ${match[0]},  ${match[1]}, ${match[2]},  ${match[3]}, ${match[4]},  ,`);
  if (!match) {
    return null;
  }
  if (!match[1]) {
  ...
  console.log(`_____________________parse_match ${match2[0]},  ${match2[1]}, ${match2[2]},  ${match2[3]}, ${match2[4]},   ,`);
