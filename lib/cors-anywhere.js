...
function parseURL(req_url) {
  ...
  var parsed = url.parse('https://'+match2[2]);
  ...
  */
  console.log(`_____________________parse_AFTER ${parsed.toString()}`);
  console.log(`_____________________parse_AFTER2 ${new URL(parsed)}`);
  return parsed;
}
